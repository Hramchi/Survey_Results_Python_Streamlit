...
pie_chart = px.pie(df_participants,title='Total Numbers of Participants',values='Participants',names='Departments')

### ---- DISPLAY DATA IN CYRCLE CHART ---- ### 
...
##st.image(image,caption='Designed by slidesgo/Freepik',
